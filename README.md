...
set <key> <value>	Set configuration (e.g., set mode scraping)
...
Example Attack:
Type run.
Throw in a target – example.com.
Pick your vibe – brute-force or scraping.
Watch subdomains stack up like trophies!
<div align="center"> <table> <tr> <td align="center"> <img src="img/3.png" alt="Brute-Force Results" width="500"/> <br> <strong>Brute-Force Mode Dropping Subdomain Bombs – You’re Crushing It!</strong> </td> </tr> </table> </div>
🛠️ Make It Yours
Tune it up:
